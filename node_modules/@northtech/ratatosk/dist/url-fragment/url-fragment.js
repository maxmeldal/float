...
export class UrlFragment extends UrlFragmentCore {
    ...
    static get globalInstance() {
        let instance = window[UrlFragment.singletonSymbol];
        if (!instance) {
            instance = window[UrlFragment.singletonSymbol] = new UrlFragment();
        }
        return instance;
    }
}
UrlFragment.singletonSymbol = Symbol.for('dk.northtech.ratatosk.UrlFragment');
