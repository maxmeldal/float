...
export class ComparisonChain<T> {
   ...
   */
  constructor(private fieldGetters: Array<(o: T) => any> = [], private collator = COLLATOR_DA) {
  }
  ...
  buildComparator(): (a: T | null | undefined, b: T | null | undefined) => number {
    if (this.fieldGetters.length) {
      ...
      return (a: T | null | undefined, b: T | null | undefined) => compare(a, b, this.collator);
    }
  }
}
 ...
 */
export function compare(a: any, b: any, collator = COLLATOR_DA): number {
  if (a == undefined && b == undefined) {
    return 0;
  }
  if (a == undefined) {
 ...
 */
export function numberAwareStringCompare(s1: string | undefined, s2: string | undefined, collator = COLLATOR_DA): number {
...
function digitAt(s: string, pos: number): number | undefined {
