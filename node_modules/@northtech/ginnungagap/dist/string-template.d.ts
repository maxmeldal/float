 ...
 * still in their `${...}` form.
 */
export declare function resolveTemplate(template: string, values: {
    [key: string]: any;
} | undefined | null, returnIncompleteResult?: false): string | undefined;
/**
 * Resolves a string template with placeholders on the form `${name}` with the values given in an object.
 * E.g. `resolveTemplate('Hello ${subject}', {subject: 'world'})` yields `'Hello world'`.
 * @param template The template string
...
export declare function resolveTemplate(template: string, values: {
    [key: string]: any;
} | undefined | null, returnIncompleteResult: true): string;
