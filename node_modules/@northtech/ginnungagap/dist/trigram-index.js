...
export class TrigramIndex {
    constructor() {
        ...
        this.docList = [];
        this.stringMapper = TrigramIndex.defaultSearchStringMapper;
        this.docsByTrigram = {};
    }
    static defaultSearchStringMapper(o) {
     ...
     */
    static of(docs, mapperFunction) {
        return mapperFunction
            ? new TrigramIndex().searchStringMapper(mapperFunction).addAll(docs)
            : new TrigramIndex().addAll(docs);
    }
    /**
     ...
     */
    searchStringMapper(mapperFunction) {
     ...
     * @see emptySearchReturns
     */
    emptySearchReturnsAllIfFewerThan(threshold) {
     ...
     */
    find(searchString, maxHits = 10, quality = 0.3) {
        /*
        if (!searchString) {
