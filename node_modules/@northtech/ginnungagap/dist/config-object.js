 ...
 *
 *  Also, consider whether the ES6 ´Object.fromEntries()` fulfills the purpose.
 */
export function toConfigObject(...o) {
    const c = {};
    for (let i = 0; i < o.length; i++) {
        ...
        if (Array.isArray(el)) {
            ...
            if (elArray[0] != undefined) {
                c[elArray[0].toString()] = toValue(elArray[1]);
            }
        }
        else if (typeof el === 'object') {
            for (const key in el) {
                if (Object.prototype.hasOwnProperty.call(el, key)) {
                    c[key.toString()] = toValue(el[key]);
                }
            }
        }
        else {
 ...
 */
export function collapseParamsToConfigObject(nameOrConfigObject, value, name2, value2, name3, value3, name4, value4) {
